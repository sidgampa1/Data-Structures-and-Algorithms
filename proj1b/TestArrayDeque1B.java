...
public class TestArrayDeque1B {
	...
	public ArrayDequeSolution<Integer> correct = new ArrayDequeSolution<Integer>();
	public StudentArrayDeque<Integer> buggy = new StudentArrayDeque<Integer>();
	public String errorMessage = "";

	@Test
	public void testRandom(){
		for(int i = 0; i < 10000000; i++){
			int random = StdRandom.uniform(6);
			if(random == 0){
				testAddFirst();	
			}
			else if(random == 1){
