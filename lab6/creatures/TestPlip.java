...
public class TestPlip {
    ...
    public void testReplicate() {
        ...
        double newEnergy = p.energy();
        assertEquals(energy / 2.0, newEnergy, 0.01);
        assertEquals(newEnergy, baby.energy(), 0.01);
        assertEquals(energy / 2.0, baby.energy(), 0.01);
